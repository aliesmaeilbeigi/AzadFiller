...
**این پروژه توسط علی اسماعیل بیگی با کمک Grok 3، هوش مصنوعی توسعه‌یافته توسط xAI، ساخته شده است. حتی ساختار کلی این فایل README نیز توسط Grok 3 نوشته شده است!**
<br><br>
## عکس افزونه:
